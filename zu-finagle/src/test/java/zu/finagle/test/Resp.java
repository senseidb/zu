...
public class Resp implements TBase<Resp, Resp._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("Resp");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(Resp.class, metaDataMap);
  }
   ...
   */
  public Resp(Resp other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.len = other.len;
  }

  public Resp deepCopy() {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Resp)
      return this.equals((Resp)that);
    return false;
  }

  public boolean equals(Resp that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Resp other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Resp typedOther = (Resp)other;
